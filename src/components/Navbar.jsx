      ...
      <div className="mx-auto max-w-6xl px-4 py-6">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="md:hidden rounded-full border border-black/15 bg-white px-4 py-2
                       text-lg font-semibold text-black shadow-soft hover:bg-neutral-50"
          >
            Menu
          </button>
        </div>
        ...
        {open && (
          <div className="md:hidden mt-6 rounded-2xl bg-white shadow-xl border border-black/10">
            <nav className="flex flex-col divide-y text-lg font-medium text-neutral-800 font-alata">
              <a
                href="#services"
                onClick={() => setOpen(false)}
                className="px-6 py-4 hover:bg-neutral-100"
              >
                Our Services
              </a>
              <a
